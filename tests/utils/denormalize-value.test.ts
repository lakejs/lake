...
describe('utils.denormalizeValue()', () => {
  ...
  it('denormalizes special tags', () => {
    expect(denormalizeValue('<figure type="block" name="hr"><span class="figure-left"><br /></span><div class="figure-body" contenteditable="false"><hr /></div><span class="figure-right"><br /></span></figure>')).to.equal('<figure type="block" name="hr"></figure>');
