...
import './plugins/media/media-box.test';
import './plugins/media/media-box-ui.test';
import './plugins/media/index.test';
...
import './plugins/emoji/emoji-box.test';
import './plugins/emoji/emoji-box-ui.test';
import './plugins/emoji/index.test';
import './plugins/equation/equation-box.test';
