...
export default {
  ...
  slash: {
    heading1: '제목 1',
    heading1Desc: '1 단계 제목을 만듭니다',
    heading2: '제목 2',
    heading2Desc: '2 단계 제목을 만듭니다',
    heading3: '제목 3',
    heading3Desc: '3 단계 제목을 만듭니다',
    heading4: '제목 4',
    heading4Desc: '4 단계 제목을 만듭니다',
    heading5: '제목 5',
    heading5Desc: '5 단계 제목을 만듭니다',
    heading6: '제목 6',
    heading6Desc: '6 단계 제목을 만듭니다',
    paragraph: '텍스트',
    paragraphDesc: '단락을 만듭니다',
    blockQuote: '인용문',
    blockQuoteDesc: '인용문을 만듭니다',
    numberedList: '순서 목록',
    numberedListDesc: '순서 목록을 만듭니다',
    bulletedList: '비순서 목록',
    bulletedListDesc: '비순서 목록을 만듭니다',
    checklist: '체크리스트',
    checklistDesc: '체크리스트를 만듭니다',
    hr: '구분선',
    hrDesc: '구분선을 삽입합니다',
    codeBlock: '코드 블록',
    codeBlockDesc: '코드 블록을 삽입합니다',
    video: '동영상',
    videoDesc: '유튜브 동영상을 삽입합니다',
    equation: '수식',
    equationDesc: '텍스 표현식을 삽입합니다',
  },
  link: {
    newLink: '새 링크',
    url: '링크 URL',
