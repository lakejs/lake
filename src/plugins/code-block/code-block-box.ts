...
function getHighlightStyle(CodeMirror: any, colors: Record<string, string>): any {
  ...
  return HighlightStyle.define([
    ...
    { tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: colors.typeName },
    ...
    { tag: [tags.bool, tags.atom, tags.special(tags.variableName)], color: colors.bool },
